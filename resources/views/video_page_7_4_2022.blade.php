                        ...
                        <div class="panel-title">
                             ...
                             <div class="swiper-wrapper">      
                                      <div class="carousel-item-b swiper-slide">
                                         <div class="col-md-12 tags  category_search-btn mt-0">  
                                             <button type="button" class="btn check_search_cat_pre vid_title_cat">fdlgk</button>
                           ...
                           <ul class="nav nav-tabs"> 
                              ...
                              <li class="change-preference" >
                                 <a href="{{ url('/fr_category')}}" class="change-preference span_category" >Change Preference</a> 
                              </li>
                           </ul>
                        </div>
                     </div>
