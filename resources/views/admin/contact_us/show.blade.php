                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" value="{{ $get_data->status }}" class="common_status_update ch_input" title="{{ ($get_data->status=='1') ? 'Active' : 'InActive' }}" {{ ($get_data->status=='1') ? 'checked' : '' }} data-id="{{ $get_data->id }}" data-action="contact">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
