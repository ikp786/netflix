...
{   
    ...
    public function get_home_list(Request $request) {
        ...
        { 
            ...
            if($request->sub_category_id=="all"){
                ...
                $get_trending_data =  SubProduct::orderBy('id','desc')->where(['status'=>'1','video_type'=>1,'product_id'=>$request->sub_category_id])->get();
                $get_popular_data =  SubProduct::orderBy('id','desc')->where(['status'=>'1','video_type'=>2,'product_id'=>$request->sub_category_id])->get(); 
                $get_upcomming_data =  SubProduct::orderBy('id','desc')->where(['status'=>'1','video_type'=>3,'product_id'=>$request->sub_category_id])->get();
            }    
    ...
    public function get_watchlist(Request $request) {
        ...
        $get_upcomming_data =  Bookmark::leftjoin('sub_products','sub_products.id','=','bookmarks.sub_product_id')->orderBy('bookmarks.id','desc')->where(['bookmarks.user_id' => $user_id,'sub_products.video_type'=>3])->get(['sub_products.*']); 
    ...
    public function get_my_video_list(Request $request) {
        ...
        $get_trending_data =  SubProduct::orderBy('id','desc')->where(['sub_products.video_type'=>1])->get(['sub_products.*']); 

        $get_popular_data =  SubProduct::orderBy('id','desc')->where(['sub_products.video_type'=>2])->get(['sub_products.*']);

        $get_upcomming_data =  SubProduct::orderBy('id','desc')->where(['sub_products.video_type'=>3])->get(['sub_products.*']);
