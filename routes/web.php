...
Route::post('/fr_more_video_api', [HomeController::class, 'fr_more_video_api']);
...
Route::get('/fr_video_play/{video_id}/{lang_id?}', [HomeController::class, 'fr_video_play']);

Route::get('/fr_player_test/{video_id}/{lang_id?}', [HomeController::class, 'fr_player_test']);

Route::get('/fr_page/{page_id}', [HomeController::class, 'fr_page']);

Route::any('/fr_membership', [HomeController::class, 'membership']); 
...
Route::get('/fr_signup/{code_mob?}', [HomeController::class, 'fr_signup']); 
...
Route::group(['middleware' => ['auth','verified']], function(){
    ...
    // Route::get('/dashboard', [AdminController::class, 'dashboard'])->name('dashboard');
     ...
     Route::get('video_cast_delete/{id?}', 'App\Http\Controllers\HomeController@video_cast_delete');
     Route::get('more_video_delete/{id?}', 'App\Http\Controllers\HomeController@more_video_delete');
